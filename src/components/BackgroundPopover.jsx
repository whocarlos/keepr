        ...
        <div className="popover " id="pop-over-bg">
            <div className="bg-container">
                ...
                <label htmlFor="default" >
                    <input type="radio" name="bg-color" id="default" value="#202124" className="bg-color-input" defaultChecked />
                    <CheckIcon />
                    <div className="color-container" style={{ backgroundColor: "#202124" }} id="bg-color-default">
                        <DropletIcon />
                    </div>
